...
(only-in racket/contract/base
  -> ->* ->i </c and/c any any/c chaperone-contract? cons/c contract? contract-name contract-out flat-contract? get/build-late-neg-projection list/c listof none/c non-empty-listof or/c parameter/c promise/c procedure-arity-includes/c recontract-out recursive-contract rename-contract struct-type-property/c unconstrained-domain->)
...
(only-in racket/stream
  for*/stream stream stream* stream-empty? stream-first stream-rest)
